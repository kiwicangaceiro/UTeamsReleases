...
```bash
gpg --recv-keys <FINGERPRINT-FROM-BENTOSOFT-ORG>   # once; fingerprint published on bentosoft.org
...
UTeams is a personal freeware project by Raul Bento ([bentosoft.org](https://bentosoft.org)).
